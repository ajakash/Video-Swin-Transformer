...
data_root = ''
data_root_val = ''
ann_file_train = 'data/moma/moma_activity_video_train_list.txt'
ann_file_val = 'data/moma/moma_activity_video_val_list.txt'
ann_file_test = 'data/moma/moma_activity_video_test_list.txt'
img_norm_cfg = dict(
